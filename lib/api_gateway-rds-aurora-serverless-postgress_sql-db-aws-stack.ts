...
export class RdsArroraStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // Now after creating VPC , we create cluster (db)
    /* RDS - Aurora - database */
    ...
    // now getting the secret from secret manager
    // const secret = dbCluster.node.children.filter((child) => 
    // child instanceof rds.DatabaseSecret)[0] as rds.DatabaseSecret;
    // secret.addReplicaRegion('us-west-2');
